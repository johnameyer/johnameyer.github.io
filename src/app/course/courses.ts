...
goals and seemed entertaining.',
        outcomes:
          'In the end, we implemented Brok-Man, a clone of Pac-Man named after our professor. As seen in the video, \
    ...
    projects: [
      {
        ...
        technologies: ['C++'],
        shortDesc:
          'Developed on my own an implementation of Pac-Man more similar to the original game using C++ and a simple \
graphics library',
        desc: '',
      },
    ],
    ...
    projects: [
      {
        ...
        outcomes:
          "We successfully developed an application that allows you to query restaurants around Notre Dame's campus, finding those closest to you, and plotting them on a map",
    ...
    projects: [
      {
        ...
        outcomes:
          'The bot we were able to create by the end of the semester performs pretty well against a player, but tends to have problems in the late game against the built-in bot. Since that bot was built as the result of a PhD thesis, we are very happy with its performance.',
        links: [
          {
